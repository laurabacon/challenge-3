...
function generatePassword () {
  var passwordLength = prompt("Hello! Please enter how long you would like your password to be.");
  if (passwordLength < 8) {
  ...
  var upperChar = confirm("Would you like lowercase letters to be included?");
  var lowerChar = confirm("Would you like uppercase letters to be included?");
